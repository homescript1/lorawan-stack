...
const m = defineMessages({
  ...
  mqttInfoText:
    'The Application Server exposes a MQTT server to work with streaming events. In order to use the MQTT server you need to create a new API Key, which will function as connection password. You can use the connection information below to connect.',
